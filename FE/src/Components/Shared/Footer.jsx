            ...
            <div className="footer-container">
                <div className="footer-left-container">
                    <div className="footer-col">
                        <p className="footer-col-title text-secondary">About features</p>
                    ...
                    <div className="footer-col">
                        <p className="footer-col-title text-secondary">About DuRiu</p>
                    ...
                    <div className="footer-col">
                        <p className="footer-col-title text-secondary">About Kokami</p>
                        <a
                ...
                <div className="footer-right-container">
                    <div className="footer-col">
                        <p className="footer-col-title text-secondary">Follow us</p>
                    ...
                    <div className="footer-col">
                        <p className="footer-col-title text-secondary">Technologies Used</p>
                        <div className="techs">
