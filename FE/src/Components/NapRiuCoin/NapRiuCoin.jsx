            ...
            <div className="NapRiuCoinAll">
                ...
                <div className="BodyRiuCoin">
                    <div className="top-up-container">
                        {Amount.map((tien) => (
                            <div className="NapTien" key={tien}>
